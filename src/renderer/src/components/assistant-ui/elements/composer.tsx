...
export function ComposerVoice({
  ...
  className,
  ...props
}: Omit<ComponentProps<'div'>, 'children'> & { recording: boolean; seconds: number }) {
  return (
    <div
...
export function ComposerModelTrigger({
  ...
  className,
  ...props
}: Omit<ComponentProps<'button'>, 'children'> & { model: string; open: boolean }) {
  return (
    <button
      type="button"
      aria-expanded={open}
...
export function ComposerModelItem({
  ...
  selected,
  ...props
}: Omit<ComponentProps<'button'>, 'children'> & { entry: ComposerModel; selected: boolean }) {
  return (
